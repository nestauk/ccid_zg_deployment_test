...
`,P=e=>/^#[0-9A-F]{6}$/i.test(e),M=(e,t=1)=>{var r;if(!P(e))return"";let[i,o,n]=null===(r=e.match(/\w\w/g))||void 0===r?void 0:r.map(e=>parseInt(e,16));return`rgba(${i}, ${o}, ${n}, ${t||1})`},R=E.ZP.button`
...
`;E.ZP.div`
  ...
  ${({size:e,featured:t,ratio:r})=>{if(!r)return;let i="",o=rV.indexOf(r);for(let r=0;r<=o;r++){let o=rV[r];i+=rL[`${e}.${o}${t?".featured":""}`]||""}let n=rP[`${e}.${r}${t?".featured":""}`]||rP[`${e}${t?".featured":""}`];return n?i+=n:"r16by9"===r&&(e>7||t)?i+=rR:(e>7||t)&&(i+=rM),i}};
...
`;let iG=e=>{var{name:t,className:r,tileId:i}=e,o=z(e,["name","className","tileId"]);let n=iS(),a=(0,S.useRef)(null);return iH(a),(0,S.useEffect)(()=>{if(n&&a.current)return n.bindVideoElement(i,a.current),()=>{n.getVideoTile(i)&&n.unbindVideoElement(i)}},[n,i]),S.createElement(rZ,Object.assign({},o,{ref:a,nameplate:t,className:`ch-remote-video--${i} ${r||""}`}))};function iq(e){let t=iS(),[r,i]=(0,S.useState)(!1),[o,n]=(0,S.useState)(1);return(0,S.useEffect)(()=>{if(!t)return;let r=(e,t,r,o)=>{null!==r&&i(r),null!==o&&n(o)};return t.realtimeSubscribeToVolumeIndicator(e,r),()=>t.realtimeUnsubscribeFromVolumeIndicator(e,r)},[t,e]),{muted:r,signalStrength:o}}(0,S.memo)(e=>{let{roster:t}=ig(),{tiles:r,tileIdToAttendeeId:i}=it();return S.createElement(S.Fragment,null,r.map(r=>{let{name:o}=t[i[r]]||{};return S.createElement(iG,Object.assign({},e,{key:r,tileId:r,name:o}))}))}),(0,S.memo)(e=>{let t=rF(),{roster:r}=ig(),{tileId:i}=function(){let e=(0,S.useContext)(ir);if(!e)throw Error("useFeaturedTileState must be used within an FeaturedVideoTileProvider");return e}(),{tileId:o}=r4(),{tiles:n,tileIdToAttendeeId:a}=it();return S.createElement(S.Fragment,null,n.map(n=>{let s=!o&&i===n,f=`${s?"ch-featured-tile":""} ${e.className||""}`,{name:l}=r[a[n]]||{};return S.createElement(iG,Object.assign({tileId:n,name:l},e,{className:f,key:n,css:t&&s?"grid-area: ft;":""}))}))});let iJ=E.ZP.div`
  ...
  ${I}
  ${T}
`;function iY(e){let t=iS(),r=iq(e),[i,o]=(0,S.useState)(()=>{var r,i,o;if(!t)return null;let n=e===(null===(o=null===(i=null===(r=t.audioVideoController)||void 0===r?void 0:r.realtimeController)||void 0===i?void 0:i.state)||void 0===o?void 0:o.localAttendeeId),a=t.getAllVideoTiles().find(t=>{let r=t.state();return!r.isContent&&(!n||!!r.active)&&r.boundAttendeeId===e});return a?a.state().tileId:null}),[n,a]=(0,S.useState)(()=>{if(!t)return null;let r=t.getAllVideoTiles().find(t=>{let r=t.state();return!!r.boundAttendeeId&&!!r.isContent&&new A.DefaultModality(r.boundAttendeeId).base()===e});return r?r.state().tileId:null});(0,S.useEffect)(()=>{if(!t)return;let r={videoTileDidUpdate:t=>{if(t.boundAttendeeId===e){if(t.localTile&&i&&!t.boundVideoStream){o(null);return}i||!t.tileId||t.isContent||o(t.tileId)}},videoTileWasRemoved:e=>{e===i&&o(null)}};return t.addObserver(r),()=>t.removeObserver(r)},[t,i,e]),(0,S.useEffect)(()=>{if(!t)return;let r={videoTileDidUpdate:t=>{t.isContent&&t.boundAttendeeId&&!n&&new A.DefaultModality(t.boundAttendeeId).base()===e&&a(t.tileId)},videoTileWasRemoved:e=>{e===n&&a(null)}};return t.addObserver(r),()=>t.removeObserver(r)},[t,n,e]);let s="number"==typeof i&&i>-1;return Object.assign(Object.assign({},r),{videoEnabled:s,sharingContent:"number"==typeof n&&n>-1})}(0,S.forwardRef)((e,t)=>{var{muted:r=!1,signalStrength:i,className:o}=e,n=z(e,["muted","signalStrength","className"]);let a=o?`${o} ch-mic-volume-indicator`:"ch-mic-volume-indicator";return S.createElement(iJ,Object.assign({className:a,signalStrength:i,muted:r},n),S.createElement(ea,{muted:r,className:"ch-mic-icon",poorConnection:void 0!==i&&i<=.5}),S.createElement("div",{className:"ch-bg-volume-wrapper"},S.createElement("div",{ref:t,className:"ch-bg-volume-fill","data-testid":"volume-fill"})))}),(0,S.createContext)(void 0);let iQ=()=>{let e=ix(),[t,r]=(0,S.useState)(()=>e.meetingStatus);return(0,S.useEffect)(()=>{let t=e=>{r(e)};return e.subscribeToMeetingStatus(t),()=>{e.unsubscribeFromMeetingStatus(t)}},[]),t},iX=["20rem","35.5rem","48rem","64rem","90rem"];iX.xs=iX[0],iX.sm=iX[1],iX.md=iX[2],iX.lg=iX[3],iX.xl=iX[4];let iK={min:{xs:`@media screen and (min-width: ${iX.xs})`,sm:`@media screen and (min-width: ${iX.sm})`,md:`@media screen and (min-width: ${iX.md})`,lg:`@media screen and (min-width: ${iX.lg})`,xl:`@media screen and (min-width: ${iX.xl})`},max:{xs:`@media screen and (max-width: ${iX.xs})`,sm:`@media screen and (max-width: ${iX.sm})`,md:`@media screen and (max-width: ${iX.md})`,lg:`@media screen and (max-width: ${iX.lg})`,xl:`@media screen and (max-width: ${iX.xl})`}},i0={breakpoints:iX,mediaQueries:iK,fonts:{body:"'Ember', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;",monospace:"Menlo, monospace"},fontSizes:{baseFontSize:"16px",fontWeight:"normal",h1:{fontSize:"5.3rem",fontWeight:"normal",lineHeight:"5.625rem",mobile:{fontSize:"3.8125rem",fontWeight:"normal",lineHeight:"5.625rem"}},h2:{fontSize:"3.925rem",fontWeight:"normal",lineHeight:"3.75rem",mobile:{fontSize:"3.05rem",fontWeight:"normal",lineHeight:"4.5rem"}},h3:{fontSize:"2.44125rem",fontWeight:"normal",lineHeight:"3.75rem",mobile:{fontSize:"2.90625rem",fontWeight:"normal",lineHeight:"3rem"}},h4:{fontSize:"1.953125rem",fontWeight:"normal",lineHeight:"3.75rem",mobile:{fontSize:"2.15rem",fontWeight:"normal",lineHeight:"3rem"}},h5:{fontSize:"1.5625rem",fontWeight:"normal",lineHeight:"3rem",mobile:{fontSize:"1.59375rem",fontWeight:"normal",lineHeight:"1.875rem"}},h6:{fontSize:"1.25rem",fontWeight:"normal",lineHeight:"1.875rem",mobile:{fontSize:"1.18125rem",fontWeight:"normal",lineHeight:"1.5rem"}},text:{fontSize:"0.875rem",lineHeight:"1.43"},label:{fontSize:"0.875rem",lineHeight:"1.43"},small:{fontSize:"0.75rem",lineHeight:"1.43"},footnote:{fontSize:"0.65rem",lineHeight:"1rem"}},radii:{default:"0.25rem",circle:"50%"},zIndex:{navigation:10,controlBar:15,modal:20,popOver:30,notificationGroup:40},modalSizes:{md:{width:"35rem",height:"94vh"},lg:{width:"50rem",height:"94vh"},fullscreen:{width:"98vw",height:"96vh"}},iconButtonSizes:{sm:"1.5rem",md:"2.5rem",lg:"4rem"}},i1={primary:{lightest:"#88b2ff",lighter:"#5d96ff",light:"#327aff",main:"#075fff",dark:"#004ddb",darker:"#0042bb",darkest:"#002f85"},secondary:{light:"#ff8e74",main:"#ff7654",dark:"#e86c4d"},error:{lightest:"#FCF7F6",lighter:"#F5DDD5",light:"#FF927C",primary:"#C52000",dark:"#9E3319",darker:"#89301A",darkest:"#791800"},success:{lightest:"#EBF1EA",lighter:"#CEE0C8",light:"#50CD49",primary:"#067000",dark:"#305D1D",darker:"#2C511D",darkest:"#184206"},info:{lightest:"#DADFE7",lighter:"#C4CCD9",light:"#418AFD",primary:"#2555A0",dark:"#264A82",darker:"#243F6B",darkest:"#123366"},warning:{lightest:"#FAF8EA",lighter:"#F7E79E",light:"#F9DC60",primary:"#F9CC09",dark:"#665A2A",darker:"#584E26",darkest:"#534201"},greys:{black:"#000000",grey100:"#1b1c20",grey90:"#2e2f34",grey80:"#3f4149",grey70:"#50545e",grey60:"#616672",grey50:"#7d818b",grey40:"#989da5",grey30:"#d4d5d8",grey20:"#e4e9f2",grey10:"#f0f1f2",white:"#ffffff"}},i5={bgd:i1.greys.white,text:i1.greys.grey80,fontSize:i0.fontSizes.baseFontSize},i2={none:"none",small:`0 0.09375rem 0.0625rem 0 ${M(i1.greys.grey100,.15)}`,medium:`0 0.5rem 0.85rem 0 ${M(i1.greys.black,.15)}`,large:`0 0.75rem 1.875rem 0 ${M(i1.greys.black,.15)}`},i3={primary:{shadow:i2.none,static:{bgd:i1.primary.light,border:`0.03125rem solid ${i1.primary.darker}`,text:i1.greys.white,shadow:"none"},hover:{bgd:i1.primary.dark,border:`0.03125rem solid ${i1.primary.darkest}`,text:i1.greys.white,shadow:"none"},focus:{bgd:i1.primary.dark,border:`0.03125rem solid ${i1.primary.darker}`,text:i1.greys.white,shadow:`0 0 0 0.25rem ${i1.primary.lightest}`},active:{bgd:i1.primary.darker,border:`0.03125rem solid ${i1.greys.black}`,text:i1.greys.white,shadow:`0 0 0 0.25rem ${i1.primary.lightest}`},selected:{bgd:i1.primary.light,border:`0.03125rem solid ${i1.primary.dark}`,text:i1.greys.white,shadow:"none"},disabled:{bgd:i1.greys.white,border:`0.03125rem solid ${i1.greys.grey10}`,text:i1.greys.grey40,shadow:"none"}},secondary:{shadow:i2.none,static:{bgd:i1.greys.white,border:`0.03125rem solid ${i1.greys.grey30}`,text:i1.greys.grey80,shadow:"none"},hover:{bgd:i1.greys.grey10,border:`0.03125rem solid ${i1.greys.grey30}`,text:i1.greys.grey80,shadow:"none"},focus:{bgd:i1.greys.grey10,border:`0.03125rem solid ${i1.primary.dark}`,text:i1.greys.grey80,shadow:`0 0 0 0.25rem ${i1.primary.light}`},active:{bgd:i1.greys.grey20,border:`0.03125rem solid ${i1.greys.grey40}`,text:i1.greys.grey80,shadow:`0 0 0 0.25rem ${i1.primary.dark}`},selected:{bgd:i1.greys.grey10,border:`0.03125rem solid ${i1.greys.grey30}`,text:i1.greys.grey80,shadow:`0 0 0 0.25rem ${i1.primary.dark}`},disabled:{bgd:i1.greys.white,border:`0.03125rem solid ${i1.greys.grey10}`,text:i1.greys.grey40,shadow:"none"}},icon:{shadow:i2.none,static:{bgd:"transparent",border:"0.03125rem  solid transparent",text:i1.greys.grey80,shadow:"none"},hover:{bgd:i1.primary.dark,border:"0.03125rem  solid transparent",text:i1.greys.white,shadow:"none"},focus:{bgd:"transparent",border:`0.03125rem  solid ${i1.primary.darker}`,text:i1.greys.grey80,shadow:`0 0 0 0.25rem ${i1.primary.lightest}`},active:{bgd:i1.primary.darker,border:`0.03125rem  solid ${i1.primary.darker}`,text:i1.greys.white,shadow:`0 0 0 0.25rem ${i1.primary.lightest}`},selected:{bgd:i1.primary.light,border:`0.03125rem  solid ${i1.primary.darker}`,text:i1.greys.white,shadow:"none"},disabled:{bgd:"transparent",border:"none",text:i1.greys.grey40,shadow:"none"}}},i4={bgd:i1.greys.white,border:`0.03125rem solid ${i1.greys.grey30}`,borderRadius:i0.radii.default,fontColor:i1.greys.grey80,placeholder:i1.greys.grey40,shadow:`0 0.0625rem 0.0625rem 0 ${M(i1.greys.black,.1)}`,clearBg:i1.greys.grey50,focus:{bgd:i1.greys.white,border:`solid 0.03125rem ${i1.primary.lighter}`,shadow:`0 0 0 0.125rem ${i1.primary.lightest}`},error:{border:`0.03125rem solid ${i1.error.dark}`,fontColor:i1.error.primary,shadow:`0 0 0 0.125rem ${i1.error.light}`},checked:{bgd:i1.primary.main,border:`solid 0.03125rem ${i1.primary.main}`,fontColor:i1.greys.white,shadow:`0 0.03125rem 0.03125rem 0 ${M(i1.primary.dark,.7)}`}},i7={bgd:i1.greys.white,text:i1.greys.grey80,wrapperBgd:M(i1.greys.grey50,.9),titleSize:i0.fontSizes.h5.fontSize,titleWeight:"normal",shadow:i2.large,border:i1.greys.grey30},i6={menuBgd:`${M(i1.greys.grey10,.85)}`,menuBorder:`0.5px solid ${i1.greys.grey20}`,shadow:i2.large,itemBgd:"transparent",itemText:i1.greys.grey70,titleText:i1.greys.grey60,active:{itemBgd:i1.primary.dark,itemText:i1.greys.white},disabled:i1.greys.grey40,separator:`${M(i1.greys.grey40,.3)}`},i8={shadow:i2.large,error:{text:i1.error.lightest,closeButton:{text:i1.error.lighter,hover:{bgd:i1.error.lighter,text:i1.error.dark},active:{bgd:i1.error.lightest,text:i1.error.darker}}},success:{text:i1.success.lightest,closeButton:{text:i1.success.lighter,hover:{bgd:i1.success.lighter,text:i1.success.dark},active:{bgd:i1.success.lightest,text:i1.success.darker}}},info:{text:i1.info.lightest,closeButton:{text:i1.info.lighter,hover:{bgd:i1.info.lighter,text:i1.info.dark},active:{bgd:i1.info.lightest,text:i1.info.darker}}},warning:{text:i1.warning.darker,closeButton:{text:i1.warning.dark,hover:{bgd:i1.warning.dark,text:i1.greys.white},active:{bgd:i1.warning.darker,text:i1.greys.white}}}},i9={fontColor:i1.primary.main,fontColorHover:i1.primary.dark,fontColorActive:i1.primary.darker,fontColorVisited:i1.primary.darkest},oe={text:i1.greys.grey70,shadow:i2.large,bgd:i1.greys.white,border:`0.03125rem solid ${i1.greys.grey20}`,opacity:1,selected:{text:i3.primary.selected.text,bgd:i3.primary.selected.bgd}},ot={title:i1.greys.grey100,primaryText:i1.greys.grey80,secondaryText:i1.greys.grey50,headerBorder:i1.greys.grey40,containerBorder:i1.greys.grey30,bgd:i1.greys.grey10,fgd:i1.greys.white,shadow:i2.large,maxWidth:"18.5rem"},or={text:i1.greys.grey80,bgd:i1.greys.grey10,headerBorder:i1.greys.grey40,wrapperBgd:M(i1.greys.grey50,.9)},oi={bgd:i1.greys.white},oo={incoming:{bgd:i1.greys.white,fontColor:i1.greys.grey60,linkColor:i1.primary.main,linkColorHover:i1.primary.dark,linkColorActive:i1.primary.darker,linkColorVisited:i1.primary.darkest},outgoing:{bgd:i1.primary.main,fontColor:i1.greys.grey10,linkColor:i1.greys.white,linkColorHover:i1.greys.grey10,linkColorActive:i1.greys.grey20,linkColorVisited:i1.greys.grey30},container:{fontColor:i1.greys.grey70,bgd:i1.greys.grey10}},on={size:{fontColor:i1.greys.grey40,bgd:i1.greys.white,letterSpacing:"-0.07px",lineHight:"16px",fontSize:"10.4px"},icon:{bgd:i1.greys.grey10,color:i1.greys.grey80},name:{fontColor:i1.greys.grey80},content:{letterSpacing:"-0.09px",bgd:i1.greys.white,fontColor:i1.greys.grey80}},oa={bgd:i1.greys.white,fontColor:i1.greys.grey70,border:"1px solid transparent",active:{bgd:i1.primary.dark,fontColor:i1.greys.white},hover:{bgd:i1.greys.grey10},focus:{border:`1px solid ${i1.primary.dark}`,selectedBorder:`1px solid ${i1.greys.grey10}`},selected:{bgd:i1.primary.light,fontColor:i1.greys.white},iconButton:{activeBgd:i1.greys.white}},os={bgd:i1.greys.grey60,fontColor:i1.greys.white},of=Object.assign({name:"Light Theme",buttons:i3,colors:i1,globalStyle:i5,links:i9,shadows:i2,inputs:i4,modal:i7,popOver:i6,notification:i8,controlBar:oe,roster:ot,navbar:or,videoGrid:oi,chatBubble:oo,channelList:oa,chatDateHeader:os,messageAttachment:on},i0),ol={primary:{lightest:"#9DEFFB",lighter:"#8AEBFA",light:"#62E5F9",main:"#4FE2F8",dark:"#29DCF8",darker:"#22B6CB",darkest:"#1FA1B5"},secondary:{light:"#FF8B70",main:"#FF9B83",dark:"#FFB4A1"},error:{lightest:"#FBC1C0",lighter:"#FDA8A6",light:"#FD9B99",primary:"#FF8B8A",dark:"#583A39",darker:"#452F2E",darkest:"#302020"},success:{lightest:"#F4FBF1",lighter:"#D2F1C5",light:"#BAF39E",primary:"#A3E881",dark:"#4F6444",darker:"#46573D",darkest:"#324129"},info:{lightest:"#F0F5FD",lighter:"#D8E6FB",light:"#C4DBFF",primary:"#BAD4FF",dark:"#555B69",darker:"#494F59",darkest:"#343C48"},warning:{lightest:"#FDFDF7",lighter:"#3F4149",light:"#FFEB96",primary:"#FBDF64",dark:"#6D653C",darker:"#5E5736",darkest:"#47422D"},greys:{black:"#000000",grey100:"#1b1c20",grey90:"#2e2f34",grey80:"#3f4149",grey70:"#50545e",grey60:"#616672",grey50:"#7d818b",grey40:"#989da5",grey30:"#d4d5d8",grey20:"#e4e9f2",grey10:"#f0f1f2",white:"#ffffff"}},od={bgd:ol.greys.grey80,text:ol.greys.white,fontSize:i0.fontSizes.baseFontSize},oc={none:"none",small:"",medium:"",large:`0 0.75rem 1.875rem 0 ${M(ol.greys.black,.15)}`},ou={primary:{shadow:oc.none,static:{bgd:ol.primary.main,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},hover:{bgd:ol.primary.dark,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},focus:{bgd:ol.primary.dark,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:`0 0 0 0.25rem ${ol.primary.darkest}`},active:{bgd:ol.primary.darker,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},selected:{bgd:ol.primary.light,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},disabled:{bgd:ol.greys.grey80,border:`0.03125rem solid ${M(ol.greys.black,.4)}`,text:ol.greys.grey40,shadow:"none"}},secondary:{shadow:oc.none,static:{bgd:ol.greys.grey50,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.white,shadow:"none"},hover:{bgd:ol.greys.grey60,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.white,shadow:"none"},focus:{bgd:ol.greys.grey60,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.white,shadow:`0 0 0 0.25rem ${ol.primary.lighter}`},active:{bgd:ol.greys.grey70,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.white,shadow:"none"},selected:{bgd:ol.greys.grey60,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.white,shadow:"none"},disabled:{bgd:ol.greys.grey80,border:`0.03125rem solid ${M(ol.greys.black,.6)}`,text:ol.greys.grey40,shadow:"none"}},icon:{shadow:oc.none,static:{bgd:"transparent",border:"0.03125rem solid transparent",text:ol.greys.grey20,shadow:"none"},hover:{bgd:ol.primary.dark,border:`0.03125rem  solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},focus:{bgd:"transparent",border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:`0 0 0 0.25rem ${ol.primary.darker}`},active:{bgd:ol.primary.darker,border:`0.03125rem solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},selected:{bgd:ol.primary.light,border:`0 solid ${ol.greys.black}`,text:ol.greys.grey80,shadow:"none"},disabled:{bgd:"transparent",border:"none",text:ol.greys.grey40,shadow:"none"}}},op={bgd:ol.greys.grey80,border:`0.03125rem solid ${ol.greys.black}`,borderRadius:i0.radii.default,fontColor:ol.greys.white,placeholder:ol.greys.grey50,shadow:`0 0.0625rem 0.0625rem 0 ${M(ol.greys.black,.1)}`,clearBg:ol.greys.white,focus:{bgd:ol.greys.white,border:`solid 0.03125rem ${ol.primary.main}`,shadow:`0 0 0 0.125rem ${ol.primary.lighter}`},error:{border:`0.03125rem solid ${ol.error.primary}`,fontColor:ol.error.primary,shadow:`0 0 0 0.125rem ${ol.error.light}`},checked:{bgd:ol.primary.main,border:`solid 0.03125rem ${ol.primary.dark}`,fontColor:ol.greys.grey80,shadow:`inset 0 0.03125rem 0 0 ${M(ol.greys.white,.1)}`}},om={bgd:ol.greys.grey80,text:ol.greys.white,wrapperBgd:M(ol.greys.grey60,.9),titleSize:i0.fontSizes.h5.fontSize,titleWeight:"normal",shadow:`0 1rem 2rem 0 rgba(0, 0, 0, ${M(ol.greys.black,.15)})`,border:ol.greys.black},oh={menuBgd:`${M(ol.greys.grey90,.85)}`,menuBorder:ol.greys.grey100,shadow:oc.large,itemBgd:"transparent",itemText:ol.greys.white,titleText:ol.greys.white,active:{itemBgd:ol.primary.dark,itemText:ol.greys.grey80},disabled:ol.greys.grey40,separator:ol.greys.grey100},og={shadow:oc.large,error:{text:ol.error.darker,closeButton:{text:ol.error.dark,hover:{bgd:ol.error.dark,text:ol.greys.white},active:{bgd:ol.error.darker,text:ol.greys.white}}},success:{text:ol.success.darker,closeButton:{text:ol.success.dark,hover:{bgd:ol.success.dark,text:ol.greys.white},active:{bgd:ol.success.darker,text:ol.greys.white}}},info:{text:ol.info.darker,closeButton:{text:ol.info.dark,hover:{bgd:ol.info.dark,text:ol.greys.white},active:{bgd:ol.info.darker,text:ol.greys.white}}},warning:{text:ol.warning.darker,closeButton:{text:ol.warning.dark,hover:{bgd:ol.warning.dark,text:ol.greys.white},active:{bgd:ol.warning.darker,text:ol.greys.white}}}},ob={fontColor:ol.primary.main,fontColorHover:ol.primary.dark,fontColorActive:ol.primary.darker,fontColorVisited:ol.primary.darkest},ov={text:ol.greys.grey20,shadow:oc.large,bgd:ol.greys.grey100,border:"none",opacity:1,selected:{text:ou.primary.selected.text,bgd:ou.primary.selected.bgd}},oy={title:ol.greys.white,primaryText:ol.greys.white,secondaryText:ol.greys.grey20,headerBorder:ol.greys.black,containerBorder:ol.greys.black,bgd:ol.greys.grey100,fgd:ol.greys.grey60,shadow:oc.large,maxWidth:"18.5rem"},ow={text:ol.greys.white,bgd:ol.greys.grey100,headerBorder:ol.greys.black,wrapperBgd:M(ol.greys.grey60,.9)},ox={bgd:ol.greys.grey90},o$={incoming:{bgd:ol.greys.grey80,fontColor:ol.greys.grey30,linkColor:ol.primary.main,linkColorHover:ol.primary.dark,linkColorActive:ol.primary.darker,linkColorVisited:ol.primary.darkest},outgoing:{bgd:ol.primary.dark,fontColor:ol.greys.grey70,linkColor:ol.greys.grey80,linkColorHover:ol.greys.grey70,linkColorActive:ol.greys.grey60,linkColorVisited:ol.greys.grey50},container:{fontColor:ol.greys.grey30,bgd:ol.greys.black}},ok={size:{fontColor:ol.greys.grey30,bgd:ol.greys.grey10,letterSpacing:"-0.07px",lineHight:"16px",fontSize:"10.4px"},icon:{bgd:ol.greys.grey40,color:ol.greys.grey10},name:{fontColor:ol.greys.white},content:{letterSpacing:"-0.09px",bgd:ol.greys.grey60,fontColor:ol.greys.white}},oS={bgd:ol.greys.grey80,fontColor:ol.greys.grey10,border:"1px solid transparent",active:{bgd:ol.primary.dark,fontColor:ol.greys.grey70},hover:{bgd:ol.greys.grey70},focus:{border:`1px solid ${ol.primary.dark}`,selectedBorder:`1px solid ${ol.greys.grey70}`},selected:{bgd:ol.primary.light,fontColor:ol.greys.grey70},iconButton:{activeBgd:ol.greys.grey80}},oE={bgd:ol.greys.grey10,fontColor:ol.greys.grey80};Object.assign({name:"Dark Theme",buttons:ou,colors:ol,globalStyle:od,links:ob,shadows:oc,inputs:op,modal:om,popOver:oh,notification:og,controlBar:ov,roster:oy,navbar:ow,videoGrid:ox,chatBubble:o$,channelList:oS,chatDateHeader:oE,messageAttachment:ok},i0);let oO=(0,E.iv)`
